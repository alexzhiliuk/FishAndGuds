...
- выбор заведения и прямые переходы к его бронированию, доставке, отзывам и телефону.
...
- выбор ресторана и настройка резервной ссылки бронирования, доставки, отзывов и телефона;
...
- ссылки на доставку и отзывы, а также телефон задаются администратором отдельно для каждого ресторана и сохраняются в PostgreSQL;
