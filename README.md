...
- переход к доставке из ресторана «Рыба и Гады».
...
- ссылки на отзывы и телефон задаются администратором отдельно для каждого ресторана; ссылка на доставку настраивается только для ресторана «Рыба и Гады». Все значения сохраняются в PostgreSQL;
