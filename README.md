...
- выбор ресторана и внешний переход на его страницы бронирования, доставки, отзывов или контактов.
...
- бронирование выполняется на внешнем сайте ресторана: бот не создаёт бронь, не хранит её статус и не отправляет подтверждение;
- кнопки бронирования и контактов используют `website_url`, полученный из iiko; если `/api/1/organizations` не вернул сайт, эти действия недоступны;
