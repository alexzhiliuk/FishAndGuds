...
def upgrade():
    ...
    mailing_type = sa.Enum("manual", "scheduled", "birthday", "holiday", name="mailingtype")
    mailing_status = sa.Enum("draft", "scheduled", "sending", "sent", "cancelled", "failed", name="mailingstatus")
    ...
    op.create_table(
        ...
        sa.Column("categories", sa.JSON(), server_default=sa.text("'[]'::json"), nullable=False),
        sa.Column("last_known_balance", sa.Numeric(12, 2), server_default="0", nullable=False),
        ...
        sa.Column("iiko_sync_status", sync_status, server_default="pending", nullable=False),
        sa.Column("iiko_synced_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    op.create_index("ix_loyalty_accounts_iiko_sync_status", "loyalty_accounts", ["iiko_sync_status"])
    ...
    op.create_table(
        ...
        sa.Column("news_enabled", sa.Boolean(), server_default=sa.true(), nullable=False),
        sa.Column("holidays_enabled", sa.Boolean(), server_default=sa.true(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_index("ix_loyalty_transactions_pos_order_id", "loyalty_transactions", ["pos_order_id"])
    op.create_index("ix_loyalty_transactions_created_at_iiko", "loyalty_transactions", ["created_at_iiko"])
    ...
    op.create_table(
        ...
        sa.Column("order_number", sa.String(64), nullable=True),
        sa.Column("amount", sa.Numeric(12, 2), server_default="0", nullable=False),
        sa.Column("bonus_earned", sa.Numeric(12, 2), server_default="0", nullable=False),
        sa.Column("bonus_spent", sa.Numeric(12, 2), server_default="0", nullable=False),
        sa.Column("purchased_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("is_delivery", sa.Boolean(), server_default=sa.false(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
